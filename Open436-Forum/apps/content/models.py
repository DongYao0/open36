...
class Post(models.Model):
    ...
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default=STATUS_PUBLISHED, db_index=True, help_text='帖子状态')
    ...
    last_edited_by = models.IntegerField(blank=True, null=True, help_text='最后编辑者ID')
...
class PostEditHistory(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    post = models.ForeignKey(Post, on_delete=models.CASCADE, db_column='post_id', related_name='edit_history')
