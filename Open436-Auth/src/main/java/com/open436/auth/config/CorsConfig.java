 ...
 * Content-Type、X-User-Id / X-Username / X-User-Role / X-User-Status（kong satoken-auth 注入）。
 */
@Configuration
public class CorsConfig {

    @Value("${cors.allowed-origins:http://localhost:3000,http://localhost:3001,http://localhost:3005,http://localhost:5173,http://localhost:8080}")
